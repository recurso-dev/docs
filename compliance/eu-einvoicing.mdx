...
keywords: ["Peppol", "EN 16931", "UBL", "VAT", "e-invoice"]
---

<Frame caption="The EU e-invoicing settings page in the Recurso dashboard">
  <img src="/images/dashboard/settings-eu.jpg" alt="The EU e-invoicing settings page in the Recurso dashboard" />
</Frame>
...
<Frame caption="A generated EN 16931 UBL 2.1 invoice (Peppol BIS Billing 3.0)">
  <img src="/images/dashboard/ubl-document.jpg" alt="Generated EN 16931 UBL invoice" />
</Frame>

## Next steps

<CardGroup cols={2}>
  <Card title="Set up EU e-invoicing" href="/setup/eu-einvoicing">
