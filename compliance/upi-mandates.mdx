...
| `revoked` | Mandate permanently canceled; no further debits possible |
...
<CardGroup cols={2}>
  <Card title="Consent tracking" href="/compliance/consent-tracking">
    The records behind every mandate
  </Card>
  <Card title="Set up UPI mandates" href="/setup/upi-mandates">
