...
<Frame caption="Dunning campaigns in the dashboard">
  <img src="/images/dashboard/dunning-campaigns.jpg" alt="Dunning campaigns in the dashboard" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Dunning campaigns" href="/advanced/dunning-campaigns">
    The engine these rules constrain
  </Card>
  <Card title="RBI e-mandates" href="/compliance/upi-mandates">
