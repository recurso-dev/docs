...
<CardGroup cols={2}>
  <Card title="UPI mandates" href="/compliance/upi-mandates">
    The consent flow's main consumer
  </Card>
  <Card title="Customer portal" href="/portal/overview">
    Where customers manage their consents
  </Card>
</CardGroup>
