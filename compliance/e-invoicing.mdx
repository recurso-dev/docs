...
## Overview
<Frame caption="E-invoicing (IRP) settings">
  <img src="/images/dashboard/settings-irp.jpg" alt="E-invoicing (IRP) settings" />
</Frame>
...
| `canceled` | E-invoice canceled on the IRP |
...
| `einvoice.void` | E-invoice was canceled on the IRP |
...
<CardGroup cols={2}>
  ...
  <Card title="Set up the IRP connection" href="/setup/india-irp">
