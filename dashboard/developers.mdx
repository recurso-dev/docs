...
<Frame caption="The Developers page in the Recurso dashboard">
  <img src="/images/dashboard/developers.png" alt="The Developers page in the Recurso dashboard" />
</Frame>
...
the same `/developer` and `/webhooks` endpoints the [SDKs](/sdk-guides/overview) use.
</Info>
