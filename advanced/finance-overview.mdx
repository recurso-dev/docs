...
Billed amounts are not revenue until they are earned. Recurso holds them in
**Deferred Revenue** and moves them into **Recognized Revenue** as each service
period elapses — the core of ASC 606 reporting:

```mermaid
flowchart LR
    P["Annual invoice issued<br/>₹12,000"] --> D["Deferred Revenue<br/>account 2100"]
    D -->|Month 1| R1["Recognize ₹1,000"]
    D -->|Month 2| R2["Recognize ₹1,000"]
    D -->|...| R3["..."]
    D -->|Month 12| R12["Recognize ₹1,000<br/>Deferred → 0"]
    R1 --> REV["Recognized Revenue<br/>account 4100"]
    R2 --> REV
    R3 --> REV
    R12 --> REV
```
