...
keywords: ["failed payments", "payment retries", "involuntary churn", "recovery"]
---

<Info>
  This page explains the concepts. To turn it on step by step, follow the [dunning setup guide](/setup/dunning).
</Info>
...
immediately and any remaining steps are canceled:
