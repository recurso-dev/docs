...
<Info>
  This page explains the concepts. To turn it on step by step, follow the [churn-prediction setup guide](/setup/churn).
</Info>
...
<CardGroup cols={2}>
  <Card title="Cancel flows" href="/advanced/cancel-flows">
