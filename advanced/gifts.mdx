...
<Info>
  This page explains the concepts. To turn it on step by step, follow the [gifts & referrals setup guide](/setup/gifts-referrals).
</Info>
...
<CardGroup cols={2}>
  <Card title="Set up gifts & referrals" href="/setup/gifts-referrals">
    Enable both growth features
  </Card>
  <Card title="Referrals" href="/advanced/referrals">
