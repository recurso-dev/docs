...
<Info>
  This page explains the concepts. To turn it on step by step, follow the [cancel-flows setup guide](/setup/cancel-flows).
</Info>
...
| `canceled` | Customer abandoned the flow |
