...
When an advance invoice is issued, the full amount enters the Deferred Revenue account (`2100`); payment then settles the receivable. Revenue is recognized month by month as each period elapses, following the standard recognition schedule described in the [Revenue Recognition](/advanced/revenue-recognition) guide.

```
Advance invoice issued (6 months × ₹4,999):
  Debit   1100 (Accounts Receivable) ₹29,994.00
  Credit  2100 (Deferred Revenue)    ₹29,994.00

Advance invoice paid:
  Debit   1000 (Cash)                ₹29,994.00
  Credit  1100 (Accounts Receivable) ₹29,994.00
