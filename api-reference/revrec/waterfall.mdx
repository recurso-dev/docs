...
The statuses above are recognition-event statuses (`pending`, `recognized`,
`failed`, …), not schedule statuses (`active`, `canceled`). Failed, canceled
and reversed events are excluded from every bucket.
